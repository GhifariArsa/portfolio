...
export const PROJECTS: Project[] = [
  ...
  },
  {
    name: "soap",
    description:
      "The Simple Organisation App, a lightweight organisation tool written in Python.",
    tags: ["Python"],
